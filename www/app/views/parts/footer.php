            ...
            <div class="modal-body">
                <table class="table text-start">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <a href="#"><img src="<?= PATH ?>/assets/img/products/apple_cinema_30.jpg"
                                         alt=""></a>
                            </td>
                        ...
                        <tr>
                            <td>
                                <a href="#"><img src="<?= PATH ?>/assets/img/products/canon_eos_5d_1.jpg"
                                         alt=""></a>
                            </td>
                        ...
                        <tr>
                            <td>
                                <a href="#"><img src="<?= PATH ?>/assets/img/products/hp_1.jpg"
                                         alt=""></a>
                            </td>
                            <td><a href="#">HP</a></td>
                            <td>1</td>
