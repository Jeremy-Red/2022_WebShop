    ...
    <div id="carouselExampleIndicators"
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?= PATH ?>/assets/img/1.jpg"
                     class="d-block w-100"
                     alt="...">
            </div>
            <div class="carousel-item">
                <img src="<?= PATH ?>/assets/img/2.jpg"
                     class="d-block w-100"
                     alt="...">
            </div>
            <div class="carousel-item">
                <img src="<?= PATH ?>/assets/img/3.jpg"
                     class="d-block w-100"
                     alt="...">
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 mb-3">
                <div class="product-card">
                    <div class="product-tumb">
                        <a href="product.html"><img src="<?= PATH ?>/assets/img/products/iphone_1.jpg"
                                 alt=""></a>
                    </div>
                    <div class="product-details">
                        <h4><a href="product.html">iPhone iPhone iPhone iPhone iPhone</a></h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero, possimus nostrum! 2Lorem
                            ipsum dolor sit amet, consectetur adipisicing elit. Vero, possimus nostrum!</p>
            ...
            <div class="col-lg-4 col-sm-6 mb-3">
                <div class="product-card">
                    <div class="product-tumb">
                        <a href="product.html"><img src="<?= PATH ?>/assets/img/products/canon_eos_5d_1.jpg"
                                 alt=""></a>
                    </div>
                    <div class="product-details">
            ...
            <div class="col-lg-4 col-sm-6 mb-3">
                <div class="product-card">
                    <div class="product-tumb">
                        <a href="product.html"><img src="<?= PATH ?>/assets/img/products/hp_1.jpg"
                                 alt=""></a>
                    </div>
                    <div class="product-details">
            ...
            <div class="col-lg-4 col-sm-6 mb-3">
                <div class="product-card">
                    <div class="product-tumb">
                        <a href="product.html"><img src="<?= PATH ?>/assets/img/products/apple_cinema_30.jpg"
                                 alt=""></a>
                    </div>
                    <div class="product-details">
            ...
            <div class="col-lg-4 col-sm-6 mb-3">
                <div class="product-card">
                    <div class="product-tumb">
                        <a href="product.html"><img src="<?= PATH ?>/assets/img/products/imac_1.jpg"
                                 alt=""></a>
                    </div>
                    <div class="product-details">
